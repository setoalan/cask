...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { beer_count: @brewery.beer_count, brewery_country: @brewery.brewery_country, brewery_location: @brewery.brewery_location, brewery_name: @brewery.brewery_name, owner_id: @brewery.owner_id }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { beer_count: @brewery.beer_count, brewery_country: @brewery.brewery_country, brewery_location: @brewery.brewery_location, brewery_name: @brewery.brewery_name, owner_id: @brewery.owner_id }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
